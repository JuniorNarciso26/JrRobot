...
) else if /i "%CURRENT_BRANCH%"=="v1.7-melhorias" (
    rem V1.7: build/config dedicados para nao reutilizar sdkconfig legado.
    set "BUILD_DIR=build-v1.7-melhorias"
    set "SDKCONFIG_FILE=sdkconfig.v1.7-melhorias"
